...
user1.foods.create!(name: "ゴーヤーチャンプルー", comment: "「ゴーヤーチャンプルー」は豆腐、豚肉、ゴーヤーなどを炒めた料理で沖縄県の郷土料理です。
  ゴーヤーの苦味と具材や出汁の甘味のコントラストが食欲を刺激し、夏バテ防止にも一役買う暑い沖縄ならではの料理です。")
user3.foods.create!(name: "海ぶどう", comment: "海ぶどうはクビレズタという海藻の一種で、果物のぶどうの房の形に似ていることから名付けられたそうです。
  プチプチとしたキャビアのような触感が特徴で「グリーンキャビア」とも呼ばれています。")
user3.foods.create!(name: "タコライス",
                    comment: "タコライスとはメキシコ風アメリカ料理であるタコスの具材をご飯の上に乗せた料理です。
                    「タコス」とご飯の「ライス」の2つの言葉が合わさってタコライスとなりました。
                    タコスはメキシコやアメリカにルーツのある料理ですが、タコライスは沖縄県にて1980年ごろに生まれた料理です。
                    沖縄がアメリカの統治下にあった際に、アメリカ軍によってタコスが沖縄に持ち込まれ、ご飯と結びついたとされています")
user1.foods.create!(name: "サーターアンダギー",
